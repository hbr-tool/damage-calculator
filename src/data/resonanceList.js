const resonanceList = [
    ...
    {"resonance_id":26,"resonance_name":"杏仁豆腐","resonance_text":"バトル勝利時 味方全体の闇属性スタイルのスキル回数を{0}回復する(スキル回数の回復スキルを除く)"},
    {"resonance_id":27,"resonance_name":"アイスホーン","resonance_text":"自身のスキル攻撃力+{0}%"},
    {"resonance_id":28,"resonance_name":"ローズ・パッション","resonance_text":"自身のODゲージ上昇量+{0}%"},
];
