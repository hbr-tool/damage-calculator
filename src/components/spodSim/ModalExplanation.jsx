...
import spAddIcon from 'assets/img/sp_add.png';
    ...
    return (
        <div className="p-8">
            ...
            <div>
                ...
                <img className="select_style" src={icons["YoOhshimaYukata2025_R3_Thumbnail"]} alt='[ゆるりたゆたう湯道楽]大島四ツ葉'/>
                <p>[ゆるりたゆたう湯道楽]大島四ツ葉</p>
                <p>・自動追撃：前衛の消費SP8以下の攻撃スキルの回数分、追撃を行います。</p>
                <p>  ネコジェット・シャテキの消費SP以上のSPがある場合、ネコジェット・シャテキを実行します。</p>
            </div>
            <div className="mt-4">
